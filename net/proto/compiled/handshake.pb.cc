...
const ::uint32_t
    TableStruct_handshake_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::Handshake, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::Handshake, _impl_.userid_),
        PROTOBUF_FIELD_OFFSET(::Handshake, _impl_.key_),
};

static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::Handshake)},
};
...
const char descriptor_table_protodef_handshake_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\017handshake.proto\"(\n\tHandshake\022\016\n\006userId"
    "\030\001 \001(\t\022\013\n\003key\030\003 \001(\tb\006proto3"
};
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:Handshake)
}
inline PROTOBUF_NDEBUG_INLINE Handshake::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::Handshake& from_msg)
...
Handshake::Handshake(
  ...
  // @@protoc_insertion_point(copy_constructor:Handshake)
}
inline PROTOBUF_NDEBUG_INLINE Handshake::Impl_::Impl_(
...
Handshake::~Handshake() {
  // @@protoc_insertion_point(destructor:Handshake)
  SharedDtor(*this);
}
...
const ::_pbi::TcParseTable<2, 2, 0, 27, 2> Handshake::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    ::_pbi::TcParser::GetTable<::Handshake>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    {::_pbi::TcParser::MiniParse, {}},
    // string userId = 1;
    {::_pbi::TcParser::FastUS1,
     {10, 63, 0, PROTOBUF_FIELD_OFFSET(Handshake, _impl_.userid_)}},
    {::_pbi::TcParser::MiniParse, {}},
    // string key = 3;
    {::_pbi::TcParser::FastUS1,
     {26, 63, 0, PROTOBUF_FIELD_OFFSET(Handshake, _impl_.key_)}},
  }}, {{
    65535, 65535
  }}, {{
    // string userId = 1;
    {PROTOBUF_FIELD_OFFSET(Handshake, _impl_.userid_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // string key = 3;
    {PROTOBUF_FIELD_OFFSET(Handshake, _impl_.key_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
...
// @@protoc_insertion_point(message_clear_start:Handshake)
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* Handshake::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(serialize_to_array_start:Handshake)
          ::uint32_t cached_has_bits = 0;
          (void)cached_has_bits;
          ...
          if (!this_._internal_userid().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "Handshake.userId");
          ...
          if (!this_._internal_key().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "Handshake.key");
          ...
          // @@protoc_insertion_point(serialize_to_array_end:Handshake)
          return target;
        }
        ...
        ::size_t Handshake::ByteSizeLong() const {
          const Handshake& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(message_byte_size_start:Handshake)
          ::size_t total_size = 0;
...
void Handshake::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:Handshake)
...
// @@protoc_insertion_point(class_specific_copy_from_start:Handshake)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
